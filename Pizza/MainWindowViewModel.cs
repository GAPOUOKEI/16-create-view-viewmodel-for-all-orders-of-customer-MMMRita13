...
namespace Pizza
{
    class MainWindowViewModel : BindableBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            _customerListViewModel.GetAllOrdersByCustomerRequested += NavigateToOrders;

           _orderPrepViewModel.Done += ReturnToCustomerList;
        ...
        private void OnNavigation(string dest)
        {
            switch (dest)
            {
                case "orderPrep":
                    ...
                    _orderViewModel.SelectedCustomer = null;
                    _ = _orderViewModel.LoadAllOrders();
                    break;
                case "customers":
                default:
        ...
        private void NavigateToOrder(Customer? customer)
        {
            ...
            _orderPrepViewModel.SelectedCustomer = customer;
            _orderPrepViewModel.Order = new Order
            {
